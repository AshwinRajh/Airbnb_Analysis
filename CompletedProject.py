...
with st.sidebar:
    selected = option_menu("Main Menu", ["Basic Overview", "Data Visualization", "Exploration", "About"],
...
client = pymongo.MongoClient("mongodb+srv://AshwinRajh:Spartans%401234@cluster0.a9kksg9.mongodb.net/",
...
# ------------------------- Airbnb_data.csv file
df = pd.read_csv('Airbnb_data.csv')

# -----------------------------------------------About Project Section--------------------------------------------------
if selected == "About":
    st.markdown("<h1 style='text-align: center; font-size: 40px; color: red;' >Airbnb Analysis </h1>", unsafe_allow_html=True)
    st.markdown("### :red[Overview :] Analyzing Airbnb data using MongoDB Atlas, including data cleaning, aggregation, and the creation of interactive visualizations.")
    st.markdown("### :white[Overview :]  Created by Ashwin Rajh.")
